...
import (
	...
	"github.com/crypto-zero/go-micro/v2/api/handler/web"
	"github.com/crypto-zero/go-micro/v2/api/resolver"
	"github.com/crypto-zero/go-micro/v2/api/resolver/grpc"
	"github.com/crypto-zero/go-micro/v2/api/resolver/host"
	"github.com/crypto-zero/go-micro/v2/api/resolver/path"
	...
	"github.com/crypto-zero/go-micro/v2/api/server/acme/certmagic"
	httpapi "github.com/crypto-zero/go-micro/v2/api/server/http"
	log "github.com/crypto-zero/go-micro/v2/logger"
	"github.com/crypto-zero/go-micro/v2/sync/memory"
	"github.com/crypto-zero/micro/v2/client/api/auth"
	"github.com/crypto-zero/micro/v2/internal/handler"
