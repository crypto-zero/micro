...
var _Command_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/crypto-zero/micro/v2/bot/proto/bot.proto",
}

func init() { proto.RegisterFile("github.com/crypto-zero/micro/v2/bot/proto/bot.proto", fileDescriptor0) }
