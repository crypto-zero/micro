...
import (
	...
	"github.com/crypto-zero/micro/v2/client/bot"
	"github.com/crypto-zero/micro/v2/client/cli"
	"github.com/crypto-zero/micro/v2/client/cli/new"
	"github.com/crypto-zero/micro/v2/client/cli/util"
	"github.com/crypto-zero/micro/v2/client/proxy"
	"github.com/crypto-zero/micro/v2/client/web"

	// services
	"github.com/crypto-zero/micro/v2/service/auth"
	"github.com/crypto-zero/micro/v2/service/broker"
	"github.com/crypto-zero/micro/v2/service/config"
	"github.com/crypto-zero/micro/v2/service/debug"
	"github.com/crypto-zero/micro/v2/service/health"
	"github.com/crypto-zero/micro/v2/service/network"
	"github.com/crypto-zero/micro/v2/service/registry"
	"github.com/crypto-zero/micro/v2/service/router"
	"github.com/crypto-zero/micro/v2/service/runtime"
	"github.com/crypto-zero/micro/v2/service/store"
	"github.com/crypto-zero/micro/v2/service/tunnel"

	// internals
	inauth "github.com/crypto-zero/micro/v2/internal/auth"
	"github.com/crypto-zero/micro/v2/internal/helper"
	"github.com/crypto-zero/micro/v2/internal/platform"
	_ "github.com/crypto-zero/micro/v2/internal/plugins"
