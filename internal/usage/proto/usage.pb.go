...
// source: github.com/crypto-zero/micro/v2/internal/usage/proto/usage.proto
...
func init() {
	proto.RegisterFile("github.com/crypto-zero/micro/v2/internal/usage/proto/usage.proto", fileDescriptor_usage_7cdccb5f3bba2052)
}
